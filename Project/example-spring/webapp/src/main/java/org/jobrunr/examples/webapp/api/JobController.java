...
public class JobController {
    ...
    public String index() {
        return "Hello World from JobController!<br />" +
                ...
                "- <a href=\"/jobs/do-recurring-job\">Do recurring jobs</a><br />" +
    ...
    @GetMapping(value="/do-recurring-job", produces = {MediaType.TEXT_PLAIN_VALUE})
    public  String doReccuringJobs () {
        final JobId enqueuedJobId = jobScheduler.<MyService>enqueue(myService -> myService.doRecurringJob());
